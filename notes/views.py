    ...
    def releve_notes(self, request, pk=None):
        ...
        response_data = {
            ...
            "etudiant": {
                ...
                "departement": etudiant.filiere.departement.nom if etudiant.filiere_id else "",
                "faculte": etudiant.filiere.departement.universite_tutelle.nom if etudiant.filiere_id else "",
                ...
                "diplome_vise": inscription.niveau.cycle.nom if inscription and inscription.niveau_id else "",
                "contact": etudiant.contact,
                "parent_tuteur": " ".join(filter(None, [etudiant.nom_parent, etudiant.whatsapp_parent])),
                "date_inscription": inscription.date_inscription.strftime("%d/%m/%Y") if inscription and inscription.date_inscription else "",
